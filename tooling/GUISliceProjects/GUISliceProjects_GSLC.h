...
// ------------------------------------------------
//<Enum !Start!>
enum {E_PG_MAIN,E_PG_XYMAP,E_PG_DEBUG};
...
#define MAX_ELEM_PG_DEBUG 0 // # Elems total on page
#define MAX_ELEM_PG_DEBUG_RAM MAX_ELEM_PG_DEBUG // # Elems in RAM
//<ElementDefines !End!>
...
gslc_tsElem                     m_asPage3Elem[MAX_ELEM_PG_DEBUG_RAM];
gslc_tsElemRef                  m_asPage3ElemRef[MAX_ELEM_PG_DEBUG];
...
//<InitGUI !Start!>
  ...
  gslc_PageAdd(&m_gui,E_PG_DEBUG,m_asPage3Elem,MAX_ELEM_PG_DEBUG_RAM,m_asPage3ElemRef,MAX_ELEM_PG_DEBUG);
  ...
  pElemRef = gslc_ElemXRingGaugeCreate(&m_gui,E_ELEM_RINGGAUGE1,E_PG_MAIN,&m_sXRingGauge2,
          (gslc_tsRect){14,54,45,45},
  ...
  pElemRef = gslc_ElemXRingGaugeCreate(&m_gui,E_ELEM_RINGGAUGE2,E_PG_MAIN,&m_sXRingGauge1,
          (gslc_tsRect){73,54,45,45},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_KNOB_1,E_PG_MAIN,(gslc_tsRect){23,102,24,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_KNOB_2,E_PG_MAIN,(gslc_tsRect){73,102,45,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_APPHEADER,E_PG_MAIN,(gslc_tsRect){190,10,285,32},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_KNOB_3,E_PG_MAIN,(gslc_tsRect){143,102,18,8},
    (char*)"Mid",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  KnobGaugeText3 = pElemRef;
  
  // Create E_ELEM_KNOB_4 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_KNOB_4,E_PG_MAIN,(gslc_tsRect){203,102,24,8},
    (char*)"High",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,E_ELEM_TOGGLE1,E_PG_MAIN,&m_asXToggle1,
    (gslc_tsRect){20,141,35,20},GSLC_COL_GRAY,GSLC_COL_RED_DK1,GSLC_COL_GRAY_LT3,
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,E_ELEM_TOGGLE2,E_PG_MAIN,&m_asXToggle2,
    (gslc_tsRect){20,181,35,20},GSLC_COL_GRAY,GSLC_COL_RED_DK1,GSLC_COL_GRAY_LT3,
    true,false,&CbBtnCommon);
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,E_ELEM_TOGGLE3,E_PG_MAIN,&m_asXToggle3,
    (gslc_tsRect){20,221,35,20},GSLC_COL_GRAY,GSLC_COL_RED_DK1,GSLC_COL_GRAY_LT3,
    true,false,&CbBtnCommon);
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,E_ELEM_TOGGLE4,E_PG_MAIN,&m_asXToggle4,
    (gslc_tsRect){21,262,35,20},GSLC_COL_GRAY,GSLC_COL_RED_DK1,GSLC_COL_GRAY_LT3,
    true,false,&CbBtnCommon);
  m_pElemToggle4 = pElemRef;
  
  // Create E_ELEM_TOGGLE_TEXT_1 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TOGGLE_TEXT_1,E_PG_MAIN,(gslc_tsRect){60,151,42,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TOGGLE_TEXT_2,E_PG_MAIN,(gslc_tsRect){60,191,54,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TOGGLE_TEXT_3,E_PG_MAIN,(gslc_tsRect){60,231,60,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TOGGLE_TEXT_4,E_PG_MAIN,(gslc_tsRect){61,272,36,8},
    (char*)"Custom",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  ...
  gslc_ElemXSliderSetStyle(&m_gui,pElemRef,false,GSLC_COL_BLUE,10,5,GSLC_COL_RED_DK1);
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,E_ELEM_SLIDER4,E_PG_MAIN,&m_sXSlider4,
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,E_ELEM_SLIDER5,E_PG_MAIN,&m_sXSlider5,
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,E_ELEM_SLIDER6,E_PG_MAIN,&m_sXSlider6,
  ...
  pElemRef = gslc_ElemXSliderCreate(&m_gui,E_ELEM_SLIDER7,E_PG_MAIN,&m_sXSlider7,
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT9,E_PG_MAIN,(gslc_tsRect){141,295,24,8},
    (char*)"65hz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT10 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT10,E_PG_MAIN,(gslc_tsRect){181,295,30,8},
    (char*)"125hz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT11 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT11,E_PG_MAIN,(gslc_tsRect){231,295,30,8},
    (char*)"250hz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT12 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT12,E_PG_MAIN,(gslc_tsRect){281,295,30,8},
    (char*)"500hz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT13 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT13,E_PG_MAIN,(gslc_tsRect){331,295,24,8},
    (char*)"1kHz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT14 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT14,E_PG_MAIN,(gslc_tsRect){381,295,24,8},
    (char*)"2kHz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT15 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT15,E_PG_MAIN,(gslc_tsRect){431,295,24,8},
    (char*)"4kHz",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT17 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT17,E_PG_MAIN,(gslc_tsRect){250,50,210,8},
    (char*)"Cause everyone's too scared to heal",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT18 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT18,E_PG_MAIN,(gslc_tsRect){250,60,216,8},
    (char*)"They don't give a fuck how they feel",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT19 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT19,E_PG_MAIN,(gslc_tsRect){250,70,216,8},
    (char*)"And I don't know how to deal anymore",0,E_BUILTIN5X8);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
  
  // Create E_ELEM_TEXT20 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT20,E_PG_MAIN,(gslc_tsRect){250,80,174,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT21,E_PG_MAIN,(gslc_tsRect){250,90,156,8},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT22,E_PG_MAIN,(gslc_tsRect){250,100,222,8},
