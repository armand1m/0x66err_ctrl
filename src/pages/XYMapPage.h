...
{
    gslc_tsElemRef* temp_ref = NULL;
    // if (xymap_channel_state.active_element == NULL) {
    ...
    // if (temp_ref == NULL) {
    //     log("Failed to create send y button");
    // }

    temp_ref = createXYMap({
        .context = xymap_page_context,
        .id = E_ELEM_XYMAP_BOX,
